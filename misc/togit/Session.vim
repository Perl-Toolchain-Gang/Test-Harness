...
nmap ,v :call setreg("\"",system("pbpaste"))p
nmap ,tl :TlistToggle
vmap bl :!svn blame =expand("%:p")  | sed -n =line("'<") ,=line("'>") p 
vmap c y:call system("pbcopy", getreg("\""))
...
silent only
cd ~/Works/Perl/git/test
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +495823 tapx.svn.cvt
badd +496915 tapx.svn
args tapx.svn.cvt
edit tapx.svn
...
silent! normal! zE
let s:l = 496915 - ((27 * winheight(0) + 23) / 46)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 495829 - ((28 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
495829
