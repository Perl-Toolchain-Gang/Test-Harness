...
TAP::Harness::Compatible::TAP - Documentation for the TAP format
...
C<TAP::Harness::Compatible::runtests> subroutine.
...
has five tests.  The sixth is missing.  TAP::Harness::Compatible will generate
...
TAP::Harness::Compatible silently ignores incorrect lines, but will become more
...
advantage of TAP::Harness::Compatible.
...
Andy Lester, based on the original TAP::Harness::Compatible documentation by Michael Schwern.
...
developed it further with their modifications to TAP::Harness::Compatible.
