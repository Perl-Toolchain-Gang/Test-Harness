...
CRAP: {
    my $point = TAPx::Harness::Compatible::Point->from_test_line( 'ok14 - Blah' );
...
PARSE_TODO: {
    my $point = TAPx::Harness::Compatible::Point->from_test_line( 'not ok 14 - Calculate sqrt(-1) # TODO Still too rational' );
...
PARSE_SKIP: {
    my $point = TAPx::Harness::Compatible::Point->from_test_line( 'ok 14 # skip Not on bucket #6' );
