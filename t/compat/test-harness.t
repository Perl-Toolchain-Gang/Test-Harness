...
for my $test ( sort keys %samples ) {
    SKIP: {
        ...
        eval {
            ...
            ($totals, $failed) = TAPx::Harness::Compatible::execute_tests(tests => [$test_path], out => \*NULL);
        };
        ...
        SKIP: {
            ...
            is( $@, '', '$@ is empty' );
            is( TAPx::Harness::Compatible::_all_ok($totals), $expect->{all_ok},
                                                      "$test - all ok" );
            ...
            my $output = TAPx::Harness::Compatible::get_results($totals, $failed);
